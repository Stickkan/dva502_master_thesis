...
static const _SetPoint_type_support_symbol_names_t _SetPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_drone_interfaces, msg, SetPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_drone_interfaces, msg, SetPoint)),
  }
};
...
{
  return &::custom_drone_interfaces::msg::rosidl_typesupport_cpp::SetPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_drone_interfaces, msg, SetPoint)() {
  return get_message_type_support_handle<custom_drone_interfaces::msg::SetPoint>();
}
