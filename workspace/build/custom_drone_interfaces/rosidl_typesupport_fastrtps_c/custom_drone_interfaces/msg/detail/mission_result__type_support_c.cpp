...
#include "custom_drone_interfaces/msg/detail/mission_result__rosidl_typesupport_fastrtps_c.h"
...
using _MissionResult__ros_msg_type = custom_drone_interfaces__msg__MissionResult;
...
size_t get_serialized_size_custom_drone_interfaces__msg__MissionResult(
  const void * untyped_ros_message,
...
static uint32_t _MissionResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_drone_interfaces__msg__MissionResult(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_drone_interfaces
size_t max_serialized_size_custom_drone_interfaces__msg__MissionResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_drone_interfaces__msg__MissionResult;
    is_plain =
      (
...
static size_t _MissionResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_drone_interfaces__msg__MissionResult(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, msg, MissionResult)() {
