...
static const _ComputePath_Request_type_support_symbol_names_t _ComputePath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, srv, ComputePath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_drone_interfaces, srv, ComputePath_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_drone_interfaces, srv, ComputePath_Request)() {
  return &::custom_drone_interfaces::srv::rosidl_typesupport_c::ComputePath_Request_message_type_support_handle;
}
...
static const _ComputePath_Response_type_support_symbol_names_t _ComputePath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, srv, ComputePath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_drone_interfaces, srv, ComputePath_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_drone_interfaces, srv, ComputePath_Response)() {
  return &::custom_drone_interfaces::srv::rosidl_typesupport_c::ComputePath_Response_message_type_support_handle;
}
...
static const _ComputePath_type_support_symbol_names_t _ComputePath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, srv, ComputePath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_drone_interfaces, srv, ComputePath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, custom_drone_interfaces, srv, ComputePath)() {
  return &::custom_drone_interfaces::srv::rosidl_typesupport_c::ComputePath_service_type_support_handle;
}
