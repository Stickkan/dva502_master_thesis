...
{
  new (message_memory) custom_drone_interfaces::msg::SetPoint(_init);
}

void SetPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_drone_interfaces::msg::SetPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPoint_message_member_array[3] = {
  {
    ...
    offsetof(custom_drone_interfaces::msg::SetPoint, setpoint_data),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_drone_interfaces::msg::SetPoint, frequency),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_drone_interfaces::msg::SetPoint, r_t_f),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPoint_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_drone_interfaces::msg::SetPoint),
...
{
  return &::custom_drone_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_drone_interfaces, msg, SetPoint)() {
  return &::custom_drone_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPoint_message_type_support_handle;
}
