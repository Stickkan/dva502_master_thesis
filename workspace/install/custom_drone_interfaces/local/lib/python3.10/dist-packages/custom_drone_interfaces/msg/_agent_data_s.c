...
bool custom_drone_interfaces__msg__agent_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_drone_interfaces.msg._agent_data.AgentData", full_classname_dest, 49) == 0);
  }
  custom_drone_interfaces__msg__AgentData * ros_message = _ros_message;
  {  // agentid
    PyObject * field = PyObject_GetAttrString(_pymsg, "agentid");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->agentid = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // priority
...
{
  /* NOTE(esteve): Call constructor of AgentData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_drone_interfaces.msg._agent_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgentData");
  ...
  {  // agentid
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->agentid);
    {
      int rc = PyObject_SetAttrString(_pymessage, "agentid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
