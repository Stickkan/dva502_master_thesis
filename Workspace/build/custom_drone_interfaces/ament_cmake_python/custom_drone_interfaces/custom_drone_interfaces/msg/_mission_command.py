    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_drone_interfaces.msg.MissionCommand')
            logger.debug(
...
class MissionCommand(metaclass=Metaclass_MissionCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.command_flag = kwargs.get('command_flag', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.command_flag != other.command_flag:
            return False
        return True
    ...
    def command_flag(self):
        """Message field 'command_flag'."""
        return self._command_flag

    @command_flag.setter
    def command_flag(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'command_flag' field must be of type 'int'"
            assert value >= 0 and value < 65536, \
                "The 'command_flag' field must be an unsigned integer in [0, 65535]"
        self._command_flag = value
