...
bool custom_drone_interfaces__msg__object_proximity_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_drone_interfaces.msg._object_proximity_data.ObjectProximityData", full_classname_dest, 70) == 0);
  }
  custom_drone_interfaces__msg__ObjectProximityData * ros_message = _ros_message;
  {  // agentid
...
{
  /* NOTE(esteve): Call constructor of ObjectProximityData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_drone_interfaces.msg._object_proximity_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectProximityData");
