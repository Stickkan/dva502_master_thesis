    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_drone_interfaces.msg.MissionGoal')
            logger.debug(
...
class MissionGoal(metaclass=Metaclass_MissionGoal):
    ...
    def __init__(self, **kwargs):
        ...
        self.json_mission_data = kwargs.get('json_mission_data', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.json_mission_data != other.json_mission_data:
            return False
        return True
    ...
    @builtins.property
    def json_mission_data(self):
        """Message field 'json_mission_data'."""
        return self._json_mission_data

    @json_mission_data.setter
    def json_mission_data(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'json_mission_data' field must be of type 'str'"
        self._json_mission_data = value
