...
#include "custom_drone_interfaces/msg/detail/set_point__rosidl_typesupport_fastrtps_c.h"
...
#include "custom_drone_interfaces/msg/detail/sub_waypoint__functions.h"  // setpoint_data
...
using _SetPoint__ros_msg_type = custom_drone_interfaces__msg__SetPoint;
...
size_t get_serialized_size_custom_drone_interfaces__msg__SetPoint(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPoint__ros_msg_type * ros_message = static_cast<const _SetPoint__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_drone_interfaces__msg__SetPoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_drone_interfaces
size_t max_serialized_size_custom_drone_interfaces__msg__SetPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_drone_interfaces__msg__SetPoint;
    is_plain =
      (
...
static size_t _SetPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_drone_interfaces__msg__SetPoint(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, msg, SetPoint)() {
