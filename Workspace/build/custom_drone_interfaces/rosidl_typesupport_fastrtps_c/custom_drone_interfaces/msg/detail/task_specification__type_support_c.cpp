...
#include "custom_drone_interfaces/msg/detail/task_specification__rosidl_typesupport_fastrtps_c.h"
...
using _TaskSpecification__ros_msg_type = custom_drone_interfaces__msg__TaskSpecification;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TaskSpecification__ros_msg_type * ros_message = static_cast<const _TaskSpecification__ros_msg_type *>(untyped_ros_message);
  // Field name: flag
  {
  ...
  {
    size_t size = 5;
    auto array_ptr = ros_message->settings;
  ...
  void * untyped_ros_message)
{
  ...
  _TaskSpecification__ros_msg_type * ros_message = static_cast<_TaskSpecification__ros_msg_type *>(untyped_ros_message);
  // Field name: flag
  {
    cdr >> ros_message->flag;
  }
...
static uint32_t _TaskSpecification__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_drone_interfaces__msg__TaskSpecification(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_drone_interfaces__msg__TaskSpecification;
    is_plain =
      (
...
static size_t _TaskSpecification__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_drone_interfaces__msg__TaskSpecification(
...
static message_type_support_callbacks_t __callbacks_TaskSpecification = {
...
static rosidl_message_type_support_t _TaskSpecification__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TaskSpecification,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_drone_interfaces, msg, TaskSpecification)() {
  return &_TaskSpecification__type_support;
}
