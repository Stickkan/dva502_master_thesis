...
#include "custom_drone_interfaces/msg/detail/agent_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_drone_interfaces::msg::AgentData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_drone_interfaces::msg::AgentData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_drone_interfaces::msg::AgentData *>(
    untyped_ros_message);
...
{
  return &custom_drone_interfaces::msg::typesupport_fastrtps_cpp::_AgentData__handle;
}
