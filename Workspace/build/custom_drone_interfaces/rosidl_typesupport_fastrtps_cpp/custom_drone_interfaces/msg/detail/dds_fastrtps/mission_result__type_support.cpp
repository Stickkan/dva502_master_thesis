...
#include "custom_drone_interfaces/msg/detail/mission_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_drone_interfaces::msg::MissionResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_drone_interfaces::msg::MissionResult & ros_message)
{
  // Member: result_message
  cdr >> ros_message.result_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_drone_interfaces::msg::MissionResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_drone_interfaces::msg::MissionResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_drone_interfaces::msg::MissionResult *>(
    untyped_ros_message);
...
{
  return &custom_drone_interfaces::msg::typesupport_fastrtps_cpp::_MissionResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_drone_interfaces, msg, MissionResult)() {
  return &custom_drone_interfaces::msg::typesupport_fastrtps_cpp::_MissionResult__handle;
}
